...
#get data
most_soldyear = pd.read_csv("/mount/src/dicoding-assessment/dashboard/most_sold_items_by_year.csv")
dfyear = pd.DataFrame(most_soldyear)
most_soldmonthly = pd.read_csv("/mount/src/dicoding-assessment/dashboard/most_sold_items_by_month.csv")
dfmonth = pd.DataFrame(most_soldmonthly)
payment = pd.read_csv("/mount/src/dicoding-assessment/dashboard/payments_type.csv")
